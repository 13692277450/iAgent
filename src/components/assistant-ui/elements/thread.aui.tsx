...
export const Thread: FC<ThreadProps> = ({
  ...
  return (
    <ThreadComponentsContext.Provider value={components}>
      <ComposerToolbarContext.Provider value={composerToolbar}>
...
const ThreadRoot: FC<{ isEmpty: boolean; autoFocus: boolean }> = ({
  ...
  return (
    <ThreadPrimitive.Root
      ...
      style={{
        ["--thread-max-width" as string]: "53rem",
      ...
      <ComposerPrimitive.AttachmentDropzone
        render={
          <div
            ...
            className="border-foreground/40 focus-within:border-foreground/25 data-[dragging=true]:border-ring flex w-full cursor-text flex-col gap-2 rounded-(--composer-radius) border bg-(--composer-bg) p-(--composer-padding) transition-[border-color] data-[dragging=true]:border-dashed data-[dragging=true]:bg-[color-mix(in_oklab,var(--color-accent)_50%,var(--color-background))]"
          />
        }
      >
        <ComposerAttachments />
