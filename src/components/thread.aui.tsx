...
const ThreadRoot: FC<{ isEmpty: boolean; autoFocus: boolean }> = ({
  ...
  return (
    // thread.aui.tsx 第 190-198 行
    <ThreadPrimitive.Root
      className="aui-root aui-thread-root flex h-full flex-col bg-slate-950"
      style={{
        ["--thread-max-width" as string]: "44rem",
        // ✅ 改用 rgba 格式，兼容性更好
        ["--composer-bg" as string]: "rgba(2, 6, 23, 0.85)",
        // 或者用 oklch 直接写
        // ["--composer-bg" as string]: "oklch(0.105 0 0 / 0.85)",
  ...
  return (
    <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col">
      <ComposerPrimitive.AttachmentDropzone
        ...
        p-2
        backdrop-blur-md
        shadow-[0_0_20px_rgba(34,211,238,0.25),inset_0_0_10px_rgba(34,211,238,0.1)]
        transition-all duration-300
        focus-within:border-cyan-300/80
        focus-within:shadow-[0_0_30px_rgba(34,211,238,0.5),inset_0_0_15px_rgba(34,211,238,0.2)]
        data-[dragging=true]:border-dashed
        data-[dragging=true]:border-cyan-300
        data-[dragging=true]:bg-cyan-500/10
      "
          />
        }
      >
        ...
        <ComposerPrimitive.Input
          ...
          className="aui-composer-input caret-cyan-400 placeholder:text-slate-500 max-h-48 min-h-10 w-full resize-none bg-transparent px-2.5 py-1 text-base leading-6 text-slate-100 outline-none"
          rows={1}
          autoFocus={autoFocus}
          enterKeyHint="send"
          ...
          <ComposerPrimitive.Send
            render={
              <TooltipIconButton
                ...
                variant="default"
                size="icon"
                className="aui-composer-send size-7 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white shadow-[0_0_15px_rgba(34,211,238,0.4)] hover:shadow-[0_0_25px_rgba(34,211,238,0.6)]"
...
const EditComposer: FC = () => {
  return (
    ...
    >
      <ComposerPrimitive.Root className="aui-edit-composer-root ms-auto flex w-full max-w-[85%] cursor-text flex-col rounded-(--composer-radius) border border-cyan-400/40 bg-(--composer-bg) shadow-[0_0_20px_rgba(34,211,238,0.25),inset_0_0_10px_rgba(34,211,238,0.1)] backdrop-blur-md transition-all duration-300 focus-within:border-cyan-300/80 focus-within:shadow-[0_0_30px_rgba(34,211,238,0.5),inset_0_0_15px_rgba(34,211,238,0.2)]">
        <ComposerPrimitive.Input
          className="aui-edit-composer-input text-slate-100 min-h-14 w-full resize-none bg-transparent px-4 pt-3 pb-1 text-base outline-none"
          autoFocus
        />
